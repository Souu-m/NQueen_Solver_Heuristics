...
public class DFS {
        ...
        if (row == n) {
            ...
            for (int col = 0; col < n; col++) {
                ...
                if ((cols & colBit) == 0 && (diags1 & diag1Bit) == 0 && (diags2 & diag2Bit) == 0) {
                    ...
                    nodesGenerated++; // increment the counter for generated nodes
                    ...
                    nodesRemoved++; // increment the counter for removed nodes
                }
            }
        }
    ...
    public static void main(String[] args) {
        int n = 35;
        DFS solver = new DFS(n);
        solver.getQueenPositions(n);
    }
    }
